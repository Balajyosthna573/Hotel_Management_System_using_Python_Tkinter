...
def TotalResult():
    ...
    rvip1 = Delivery/(10.0*0.5)   #=================Cost of VIP room with Delivery=====================================

    rnormal = 5.0       #=================Cost of normal room=====================================
    rnormal1 = Delivery/(5.0*2.5)     #=================Cost of normal room with Delivery=====================================
...
#================================Window's Partition==============================
Tops = Frame(root, width=1600, height=60, bg='blue',relief=SUNKEN)
Tops.pack(side=TOP)

f1 = Frame(root,width=300,height=500,relief=SUNKEN)
f1.pack(side=LEFT)

f2 = Frame(root, width=80, height=700,relief=SUNKEN)
f2.pack(side=RIGHT)

f3 = Frame(root, width=25, height=700, relief=SUNKEN)
f3.pack(side=LEFT)
...
Display = Entry(Tops, font=('arial',90,'bold'),fg='white',bd=25,bg='blue',justify='right',textvariable=txt_input)
Display.grid(columnspan=4)

#==================================Date and time=================================

lblInfo = Label(f2,font=('arial',16,'bold'),fg='dark blue',bd=5,anchor=W)
...
btn7 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='7',command=lambda:btn(7)).grid(row=2,column=0)
btn8 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='8',command=lambda:btn(8)).grid(row=2,column=1)
btn9 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='9',command=lambda:btn(9)).grid(row=2,column=2)
btnC = Button(f2,padx=6,pady=4,bd=5,font=('arial',20,'bold'),text='C',bg='green', command=Clear).grid(row=2,column=3)

#==================================Row 2========================================

btn4 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='4',command=lambda:btn(4)).grid(row=3,column=0)
btn5 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='5',command=lambda:btn(5)).grid(row=3,column=1)
btn6 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='6',command=lambda:btn(6)).grid(row=3,column=2)
btnplus = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='+',bg='orange',command=lambda:btn('+')
                 ).grid(row=3,column=3)

#==================================Row 3========================================

btn1 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='1',command=lambda:btn(1)).grid(row=4,column=0)
btn2 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='2',command=lambda:btn(2)).grid(row=4,column=1)
btn3 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='3',command=lambda:btn(3)).grid(row=4,column=2)
btnminus = Button(f2,padx=13,pady=4,bd=5,font=('arial',20,'bold'),text='-',bg='orange',command=lambda:btn('-')
                  ).grid(row=4,column=3)

#==================================Row 4========================================

btn0 = Button(f2,padx=10,pady=4,bd=5,font=('arial',20,'bold'),text='0',command=lambda:btn(0)).grid(row=5,column=0)
btndot = Button(f2,padx=16,pady=4,bd=5,font=('arial',20,'bold'),text='.',bg='orange',command=lambda:btn('.')
                ).grid(row=5,column=1)
btndivision = Button(f2,padx=13,pady=4,bd=5,font=('arial',20,'bold'),text='/',bg='orange',command=lambda:btn('/')
                     ).grid(row=5,column=2)
btnmultiply = Button(f2,padx=11,pady=4,bd=5,font=('arial',20,'bold'),text='x',bg='orange',command=lambda:btn('*')
                     ).grid(row=5,column=3)

#==================================Row 5========================================

btnequals = Button(f2,padx=50,pady=2,bd=5,font=('arial',18,'bold'),text='=',bg='green',command=Equal
                   ).grid(row=6,column=0,columnspan=2)
btnopenbracket = Button(f2,padx=13,pady=2,bd=5,font=('arial',20,'bold'),text='(',bg='orange',command=lambda:btn('(')
                        ).grid(row=6,column=2)
btnclosebracket = Button(f2,padx=13,pady=2,bd=5,font=('arial',20,'bold'),text=')',bg='orange',command=lambda:btn(')')
                         ).grid(row=6,column=3)
...
Cost = StringVar()
lblMeal1 = Label(f1, font=('arial',14,'bold'),text='Cost of Meal($)',bd=7,anchor=W)
lblMeal1.grid(row=0,column=2)
txtMeal1 = Entry(f1,font=('arial',14,'bold'),textvariable=Cost,fg='white',bd=7,insertwidth=3,bg='blue',
                 justify='right')
txtMeal1.grid(row=0,column=3)

Drinks = StringVar()
lblDrink1 = Label(f1, font=('arial',14,'bold'),text='Cost of Drink($)',bd=7,anchor=W)
lblDrink1.grid(row=1,column=2)
txtDrink1 = Entry(f1,font=('arial',14,'bold'),textvariable=Drinks,fg='white',bd=7,insertwidth=3,bg='blue',
                  justify='right')
txtDrink1.grid(row=1,column=3)

DevCost = StringVar()
lblDev = Label(f1, font=('arial',14,'bold'),text='Delivery Cost($)',bd=7,anchor=W)
lblDev.grid(row=2,column=2)
txtDev = Entry(f1,font=('arial',14,'bold'),textvariable=DevCost,fg='white',bd=7,insertwidth=3,bg='blue',
               justify='right')
txtDev.grid(row=2,column=3)

RoomCost = StringVar()
lblRoom = Label(f1, font=('arial',14,'bold'),text='Cost of Room($)',bd=7,anchor=W)
lblRoom.grid(row=3,column=2)
txtRoom = Entry(f1,font=('arial',14,'bold'),textvariable=RoomCost,fg='white',bd=7,insertwidth=3,bg='blue',
                justify='right')
txtRoom.grid(row=3,column=3)

Service_Charge = StringVar()
lblService = Label(f1, font=('arial',14,'bold'),text='Service Fee($)',bd=7,anchor=W)
lblService.grid(row=4,column=2)
txtService = Entry(f1,font=('arial',14,'bold'),textvariable=Service_Charge,fg='white',bd=7,insertwidth=3,bg='blue',
                   justify='right')
txtService.grid(row=4,column=3)

Total = StringVar()
lblTotal = Label(f1, font=('arial',14,'bold'),text='Total Cost($)',bd=7,anchor=W)
lblTotal.grid(row=5,column=2)
txtTotal = Entry(f1,font=('arial',14,'bold'),textvariable=Total,fg='white',bd=7,insertwidth=3,bg='blue',
                 justify='right')
...
#=======================================Control Buttons=========================================
btnConvert = Button(f1,padx=7,pady=5,bd=10,fg='white',font=('arial',15,'bold'),width=7,text='Convert',bg='orange',command = Convert)
btnConvert.grid(row=8,column=2)

btnTotal = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',15,'bold'),width=7,text='Total',bg='orange',command=TotalResult)
btnTotal.grid(row=0,column=0)

btnScreen = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',15,'bold'),width=7,text='Clear',bg='blue',command = ClearScreen)
btnScreen.grid(row=1,column=0)

btnReset = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',15,'bold'),width=7,text='Reset',bg='green',command=Reset
                 )
btnReset.grid(row=2,column=0)

btnExit = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',15,'bold'),width=7,text='Exit',bg='red', command=Exit
                 )
...
txtscroll = Entry(f2, textvariable=scroll_text, font=('arial',14,'bold'), fg='white', bd=7, bg='blue', width=25)
